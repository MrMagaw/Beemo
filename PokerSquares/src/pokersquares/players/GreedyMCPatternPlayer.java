 ...
 */
public class GreedyMCPatternPlayer implements PokerSquaresPlayer {
	 ...
	 */
	public GreedyMCPatternPlayer(int depthLimit) {
			...
			for (int d = 0; d < depth; d++) {
				...
				for (int i = 0; i < remainingPlays; i++) {
					...
					//score = system.getScore(grid);
                                        ...
                                        score = (int) PatternPolicy.evaluate(b);
					if (score >= maxScore) {
						if (score > maxScore)
							bestPlays.clear();
						bestPlays.add(play);
	...
	public String getName() {
		return "GreedyMCPatternPlayerDepth" + depthLimit;
	}
